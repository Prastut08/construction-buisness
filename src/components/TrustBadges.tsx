...
const badges = [
  { icon: Package, value: "15,000+", label: "Products in Catalog", color: "from-saffron/20 to-gold/10" },
  { icon: Truck, value: "Same Day", label: "Dispatch Available", color: "from-accent-blue/20 to-accent-blue/5" },
  { icon: ShieldCheck, value: "100%", label: "Brand Warranty", color: "from-accent-green/20 to-accent-green/5" },
  { icon: HeadphonesIcon, value: "24/7", label: "Expert Support", color: "from-purple-500/20 to-purple-500/5" },
  { icon: Zap, value: "500+", label: "Cities Served", color: "from-saffron/20 to-gold/10" },
  { icon: Award, value: "12 Yrs", label: "Industry Trust", color: "from-accent-blue/20 to-accent-blue/5" },
];
          ...
          {badges.map((badge, index) => {
            ...
            return (
              <motion.div
                ...
                className="glass-card glass-card-hover rounded-2xl p-5 flex flex-col items-center text-center group cursor-pointer"
              >
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${badge.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                  <Icon size={22} className="text-white/90" strokeWidth={1.5} />
                </div>
                <h3 className="text-xl md:text-2xl font-rajdhani font-bold text-white mb-0.5">
                  {badge.value}
                </h3>
